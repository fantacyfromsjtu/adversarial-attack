...
不同攻击方法在CIFAR-10测试集上的典型表现：

| 攻击方法 | 成功率 | 平均扰动大小 | 计算时间 |
|---------|--------|------------|---------|
| FGSM    | 78.2%  | 0.03 (L∞)  | 极快     |
| PGD     | 92.5%  | 0.03 (L∞)  | 快       |
| C&W     | 99.3%  | 0.12 (L2)  | 慢       |
...
| 防御方法       | 对FGSM的防御率 | 对PGD的防御率 | 对C&W的防御率 | 对JSMA的防御率 |
|--------------|--------------|-------------|-------------|--------------|
| 标准训练      | 21.8%        | 7.5%        | 0.7%        | 12.6%        |
| 对抗训练      | 76.3%        | 59.2%       | 35.7%       | 62.4%        |
| 对抗蒸馏      | 64.5%        | 51.3%       | 41.2%       | 58.7%        |
